...
<head>
    ...
    ?>
    <meta charset="utf-8">
    <title><?php echo $blogitems->title_head; ?></title>
    <meta name="title" content="<?php echo $blogitems->title_head; ?>">
    <meta name="description" content="<?php echo $blogitems->title_desc; ?>">
    <meta name="keywords" content="Непутевая Рссия / <?php echo $blogitems->keywords; ?>">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <link href="/public/style.css?11" rel="stylesheet" type="text/css">
